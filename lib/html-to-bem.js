...
export default {
  ...
  _processSelection(string, config) {
    ...
    try {
      ...
      // const output = input + outputDelimiter + stylesheetsBEM; TEST PURPOSES ONLY
      const output = stylesheetsBEM;

      // textEditor.setTextInBufferRange(textEditor.getSelectedBufferRange(), output);
      atom.clipboard.write(output);

      this._showInfoNotification('Your CSS styles for your BEM component has been added to your clipboard.');
